...
///  - cpu_setIndexing()
  ...
  cpu_setVertexPullerHead(phong.gpu, phong.puller, 0, phong.vbo, 0, sizeof(float) * 3);
  cpu_setVertexPullerHead(phong.gpu, phong.puller, 1, phong.vbo, sizeof(float) * 3, sizeof(float) * 3);
